...
- **Classification**: When a Target Feature is *Discrete valued* which means it can be countable.\ Ex: Like/Dislike, Yes/No and Image recognization: cat, dog, lion etc.
